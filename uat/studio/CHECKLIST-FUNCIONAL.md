...
- [ ] Pantalla de inicio (SCR-001): hero, CTAs, recientes, plantilla, docs/novedades; volver con **Ctrl+Shift+H**; demo con **Ctrl+Shift+D**.
...
- [ ] Docks: Ver → Explorador (**Ctrl+1**) / Inspector (**Ctrl+2**) / Timeline / Comparador; barra de herramientas (**Ctrl+Shift+K**); restablecer disposición (**Ctrl+Shift+W**).
...
- [ ] Ayuda → Novedades (**Ctrl+Shift+U**) / Documentación (**Shift+F1**) / Acerca de (**Ctrl+Shift+A**, icono correcto).
