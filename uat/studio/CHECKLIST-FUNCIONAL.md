...
- [ ] Pantalla de inicio (SCR-001): hero, CTAs, recientes, plantilla, docs/novedades.
...
- [ ] **Añadir tablero** y **añadir pieza** (menú / Explorador / CTA vacío).
...
- [ ] Docks: Ver → Explorador / Inspector / Timeline / Comparador; restablecer disposición.
...
- [ ] Importar **piezas** CSV/Excel (cantidad expandida si aplica).
...
- [ ] Exportar historial Timeline JSON/CSV.
