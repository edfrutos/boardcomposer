...
`#explainSolutionRoot` ventana LIGHT (tinta de marca o heading scoped a cada
root), body/tabla WhatsNew·Shortcuts·Explain LIGHT, botones primario LIGHT
scoped a Welcome/About/WhatsNew/Shortcuts/Explain/empty, secundarios LIGHT
scoped a Welcome/empty/Explain, empty Workspace con superficie/tinta LIGHT
