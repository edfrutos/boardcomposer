# Revisión de planificación — 2026-08-06
...
revisión previa `REVIEW-2026-08-05-planificacion.md`.  
...
Desde la revisión 2026-08-05 el ciclo `0.4.3.dev0` avanzó en pulido Welcome /
Recientes (PRs ~410–417): basename, tips de ruta, pin, quitar, revelar
carpeta, submenú de gestión por proyecto, fix QSS `system` en secundarios.
...
4. **QoL / producto `0.4.3`** — atacar cola IDE-0019…0024 (DOC-004) cuando
   haya capacidad; el pulido Welcome/Recientes no vacía esa cola.
