# Revisión de planificación — 2026-08-10
...
revisión previa `REVIEW-2026-08-09-planificacion.md`.  
...
vía `gh pr list`: #457 (tip Clear recent).
...
abierto = **QoL / tips honesty / docs bajo demanda** + residuales
(eval / piloto).

Desde la revisión 2026-08-09 el ciclo `0.4.3.dev0` avanzó sobre todo en
**tips honestos y guía de disposición** (PRs ~447–456): tip Marcador Timeline,
Comparador (ordenar / solo completas / vista previa), demo, plantillas,
nuevo proyecto, guardar como plantilla; guía rápida documenta docks, toolbar
y restablecer layout. Queda PR abierto #457 (tip Clear recent) fuera de este
pase. Snapshot planificación 08-09 ya mergeado (#448).
