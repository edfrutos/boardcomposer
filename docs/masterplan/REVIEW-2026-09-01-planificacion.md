# Revisión de planificación — 2026-09-01
...
revisión previa en `main` `REVIEW-2026-08-31-planificacion.md`.  
**Issues GitHub:** `gh issue list --state open` → **vacío** (sin bugs abiertos
visibles en el repo). **PRs abiertos al corte:** 1
(`#593` tip honesty import-boards → proyecto vacío).
...
08-31 (#588). Al corte 09-01: **Issues abiertos = 0**; **PRs abiertos = 1**
(#593 tip Importar tableros → proyecto vacío).
