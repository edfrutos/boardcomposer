# Revisión de planificación — 2026-08-29
...
revisión previa `REVIEW-2026-08-28-planificacion.md`.  
**Issues GitHub:** `gh issue list --state open` → **vacío** (sin bugs abiertos
visibles en el repo). **PRs abiertos:** ninguno al corte.
...
Desde la revisión 2026-08-28 el ciclo `0.4.3.dev0` cerró tips honesty Guardar
(#576), zoom Ctrl+0 (#578/#579), Explicar candidata sin IA en red (#580),
Seleccionar todas (#581) y el snapshot de planificación 08-28 (#577). Issues
abiertos = 0; PRs abiertos = 0.
