# Revisión de planificación — 2026-08-08
...
revisión previa `REVIEW-2026-08-07-planificacion.md`.  
...
| Timeline: tips honestos (Seguir, filtros, combos, Vaciar, copiar) + F1 | 🟢 QoL `0.4.3.dev0` |
| Guía rápida: Timeline, Comparador, selección, nudge, pan, layout | 🟢 Docs `0.4.3.dev0` |
...
abierto = **QoL bajo demanda** + residuales (eval / piloto).

Desde la revisión 2026-08-07 el ciclo `0.4.3.dev0` avanzó en Timeline y guía
rápida (PRs ~427–438): tips honestos Seguir/filtros/combos/Vaciar/copiar,
atajos nativos en status bar, filas F1 de replay y Ctrl+C Timeline, y
documentación de Comparador / Timeline / selección / nudge / pan / layout.
...
4. **QoL / producto `0.4.3`** — atacar cola IDE-0019…0024 (DOC-004) cuando
   haya capacidad; el pulido Timeline/guía no vacía esa cola.
