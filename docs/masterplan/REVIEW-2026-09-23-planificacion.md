# Revisión de planificación — 2026-09-23

**Origen:** cron diario; reconciliar snapshot `REVIEW-2026-09-22` (PR `#660`
mergeado; docs de producto mutados por `#666`/`#667`) con producto en `main`:
`#661`…`#667` (IDE-0046…0052).
**Fuentes:** `ROADMAP.md`, `MASTERPLAN.md`, `DOC-003`, `DOC-004`, `DOC-006`,
spikes IDE-0007 / DT-0006, `CHANGELOG` Unreleased, UAT release smoke,
revisión `REVIEW-2026-09-22`.
**Issues GitHub:** `gh issue list --state open` → **vacío**.
**PRs de producto al corte:** `#661`…`#667` **mergeados**; sin PRs abiertos.
**Planning mergeado previo:** `#660` (2026-09-22) — se pliega como histórico.
...
IDE-0037…0053 **entregadas** (`#647`…`#667`); sexta ola residual
0054 abierta.

Desde la revisión 2026-09-22, en `main` entraron `#661`…`#665`
(0046…0050), `#666` (0051) y `#667` (0052). Planning `#660` queda histórico.
...
- Inspector: unidades prefs mm/cm/in (IDE-0040 `#653`); disco sigue mm.
  ...
  Material por defecto de taller (IDE-0053); no va en el `.bcproj`.
...
- Alinear IDE-0053 🟢; residual cola 0054 → **sin IDE nuevas**.
