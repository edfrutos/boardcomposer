# Revisión de planificación — 2026-08-19
...
revisión previa `REVIEW-2026-08-16-planificacion.md`.  
**Issues GitHub:** `gh issue list --state open` → **vacío** (sin bugs abiertos
visibles en el repo). **PRs abiertos:** ninguno al momento del snapshot.
...
Desde la revisión 2026-08-16 el ciclo `0.4.3.dev0` amplió la ola honesty
(PRs #519…#535 mergeados): comparator sort/complete-only/pin-reference,
What's New Unreleased, open-config-folder, open-docs fallback, timeline clear
irreversible, restore-revision unsaved, apply-layout irreversible,
new-from-template placements, delete-board keeps pieces, import boards/pieces
save-mapping, restore-defaults apply-on-accept, undo/redo edit stack,
import-boards Excel sheet picker. Snapshot planificación 08-16 mergeado
(#518). Sin PRs abiertos al corte de este pase.
...
(IDE-0019…0024 + residuales). **No se añaden IDE-0025+** en este pase.
