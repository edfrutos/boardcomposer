# Revisión de planificación — 2026-09-04
...
revisión previa `REVIEW-2026-09-03-planificacion.md` (PR #596 draft, no
mergeado; se incorpora aquí como histórico junto con `REVIEW-2026-09-01` /
`REVIEW-2026-09-02` desde PRs #594/#595).  
**Issues GitHub:** `gh issue list --state open` → **vacío** (sin bugs abiertos
visibles en el repo). **PRs abiertos al corte:** 4
(`#593` tip honesty import-boards → proyecto vacío; `#594`/`#595`/`#596`
planning 09-01/09-02/09-03 draft — supersedidos por este snapshot).
...
| Tips honesty Importar piezas (crea proyecto vacío) | 🟢 QoL `0.4.3.dev0` |
...
Desde la revisión 2026-08-31 en `main`, el ciclo `0.4.3.dev0` cerró en `main`
el tip Nuevo proyecto / unidades (#589), Exportar selección (#590), Export
Timeline formato (#591), Importar piezas → proyecto vacío (#592) y el snapshot
08-31 (#588). Entre 09-01 y 09-04 **no hubo merges nuevos** a `main`. Al corte
09-04: **Issues abiertos = 0**; **PRs abiertos = 4** (#593 tip Importar
tableros → proyecto vacío; #594/#595/#596 planning drafts 09-01/09-02/09-03,
plegados aquí).
...
4. **QoL / producto `0.4.3`** — atacar cola IDE-0019…0024 (DOC-004) cuando
   haya capacidad; la ola de tips/docs no vacía esa cola. Cerrar o mergear
   `#593` si tip Importar tableros sigue el patrón de `#592`.
...
(IDE-0019…0024 + residuales eval/piloto + PR QoL `#593`). **No se añaden
IDE-0025+** en este pase.
