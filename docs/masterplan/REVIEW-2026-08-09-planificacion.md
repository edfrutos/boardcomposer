# Revisión de planificación — 2026-08-09
...
revisión previa `REVIEW-2026-08-08-planificacion.md`.  
**Issues GitHub:** API no accesible desde esta automatización (403); no se
listan bugs abiertos en la documentación de producto. PR abierto observado
vía `gh pr list`: #447 (tip Timeline Marcador).
...
| Guía rápida: Welcome, plantillas, Preferencias, Export, Workspace, Inspector, Explorador, Comparador, Timeline, selección/nudge/pan | 🟢 Docs `0.4.3.dev0` |
...
abierto = **QoL / docs bajo demanda** + residuales (eval / piloto).

Desde la revisión 2026-08-08 el ciclo `0.4.3.dev0` avanzó sobre todo en **guía
rápida** (PRs ~440–446): secciones Welcome, plantillas de proyecto,
Preferencias, Export, Workspace, Inspector y Explorador. Queda PR abierto
#447 (tip honesto Timeline Marcador) fuera de este pase.
...
4. **QoL / producto `0.4.3`** — atacar cola IDE-0019…0024 (DOC-004) cuando
   haya capacidad; el ciclo docs guía rápida no vacía esa cola.
