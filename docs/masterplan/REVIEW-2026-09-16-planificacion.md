...
| IDE-0032 presupuesto de material PDF (Ctrl+Alt+Q) | 🟢 |
...
1. **Cola `0.4.4` segunda ola** — atacar **IDE-0034 →
   0035 → 0036** (0031, 0032 y 0033 entregadas).
...
Prioridad sugerida de ataque: **0034 → 0035 → 0036**
