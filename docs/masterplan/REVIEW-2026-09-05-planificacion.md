# Revisión de planificación — 2026-09-05
...
revisión previa `REVIEW-2026-09-04-planificacion.md` (PR #597 draft, no
mergeado; se incorpora aquí como histórico junto con `REVIEW-2026-09-03`
desde PR #596). En `main` ya están `REVIEW-2026-09-01` / `REVIEW-2026-09-02`
(PRs #594/#595 mergeados).  
**Issues GitHub:** `gh issue list --state open` → **vacío** (sin bugs abiertos
visibles en el repo). **PRs abiertos al corte:** 2
(`#596` / `#597` planning drafts 09-03/09-04 — supersedidos por este
snapshot).
...
Timeline formato (#591), Importar piezas → proyecto vacío (#592), Importar
tableros → proyecto vacío (#593) y snapshots de planificación #588 / #594 /
#595 (08-31…09-02). Entre 09-03 y 09-05 **no hubo merges de producto** a
`main` (solo drafts de planificación #596/#597 abiertos). Al corte 09-05:
**Issues abiertos = 0**; **PRs abiertos = 2** (#596/#597 planning drafts
09-03/09-04, plegados aquí).
...
4. **QoL / producto `0.4.3`** — atacar cola IDE-0019…0024 (DOC-004) cuando
   haya capacidad; la ola de tips/docs no vacía esa cola. Mergear o cerrar
   drafts de planificación supersedidos (#596/#597) al aterrizar este
   snapshot.
...
(IDE-0019…0024 + residuales eval/piloto). **No se añaden IDE-0025+** en
este pase.
