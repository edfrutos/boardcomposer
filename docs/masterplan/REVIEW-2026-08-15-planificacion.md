# Revisión de planificación — 2026-08-15
...
revisión previa `REVIEW-2026-08-13-planificacion.md`.  
...
Desde la revisión 2026-08-13 el ciclo `0.4.3.dev0` amplió la ola honesty
(PRs #492…#509 mergeados): apply-layout, open, recientes (open/remove/row/
pinned), reset disposición, import tableros/piezas, export selected /
timeline / share import·export / revision-backup, diff `.bcproj`, copy ID,
fit-selection. CI: cache pip + cancelar runs supersedidos (#501). Snapshot
planificación 08-13 mergeado (#491). Sin PRs abiertos al corte de este pase.
