# Revisión de planificación — 2026-09-08
...
revisión previa `REVIEW-2026-09-07-planificacion.md` (PR #602 mergeado).  
**Issues GitHub:** `gh issue list --state open` → **vacío** (sin bugs abiertos
visibles en el repo). **PRs abiertos al corte:** 1 (`#607` tip honesty
Añadir pieza · cantidad → ids únicos).
...
Desde la revisión 2026-09-07, en `main` entraron planning #602 y tips honesty
Duplicar (#603, #606), Añadir pieza 1.º tablero (#604) e Importar piezas 1.º
tablero (#605). Al corte 09-08: **Issues abiertos = 0**; **PRs abiertos = 1**
(#607 tip Añadir pieza · cantidad → ids únicos).
