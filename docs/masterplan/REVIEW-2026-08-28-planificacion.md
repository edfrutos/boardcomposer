# Revisión de planificación — 2026-08-28
...
revisión previa `REVIEW-2026-08-27-planificacion.md`.  
**Issues GitHub:** `gh issue list --state open` → **vacío** (sin bugs abiertos
visibles en el repo). **PRs abiertos:** #576 (tip honesty Archivo → Guardar:
recuerda última carpeta; sin merge al corte).
...
Desde la revisión 2026-08-27 el ciclo `0.4.3.dev0` cerró tips honesty Timeline
replay-back / forward / lista (#572, #574, #575) y el snapshot de planificación
08-27 (#573). PR #576 (Guardar recuerda última carpeta) abierto al corte;
Issues abiertos = 0.
