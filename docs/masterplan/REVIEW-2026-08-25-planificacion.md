# Revisión de planificación — 2026-08-25
...
revisión previa `REVIEW-2026-08-24-planificacion.md`.  
...
Desde la revisión 2026-08-24 el ciclo `0.4.3.dev0` sumó tips honesty de
carpeta/proyecto: Abrir carpeta (#562), basename barra (#563), tip sin guardar
(#564) y status carpeta no disponible (#565) aclaran que abren el explorador
de archivos. Snapshot planificación 08-24 mergeado (#561). Sin Issues ni PRs
abiertos al corte de este pase.
