# Revisión de planificación — 2026-08-22
...
revisión previa `REVIEW-2026-08-21-planificacion.md`.  
...
| Tips honesty Vista: rejilla / barra herramientas (persisten) | 🟢 QoL `0.4.3.dev0` |
...
Desde la revisión 2026-08-21 el ciclo `0.4.3.dev0` sumó: tip Limpiar filtros
Timeline mergeado (#548); snapshot planificación 08-21 (#549); tips honesty
pin-recent (#550), toggle-grid (#551), toggle-toolbar (#552). Sin Issues ni
PRs abiertos al corte de este pase.
