# Revisión de planificación — 2026-08-12
...
revisión previa `REVIEW-2026-08-10-planificacion.md`.  
...
vía `gh pr list`: #474 (tip Rename template).
...
| Tips honesty menú Archivo/Edición/Ayuda + plantillas (ola 08-10…12) | 🟢 QoL `0.4.3.dev0` |
...
Desde la revisión 2026-08-10 el ciclo `0.4.3.dev0` avanzó en una **ola
amplia de tips honestos** (PRs #457…#473 mergeados): Clear recent, Exit,
What’s New, Open Docs, About, Shortcuts, Show Welcome, Preferences, Delete,
Rename Project, Save, Add Board, Add Piece, Edit Selection, Duplicate,
template-delete; snapshot planificación 08-10 mergeado (#458). Queda PR
abierto #474 (tip Rename template) fuera de este pase.
