# Revisión de planificación — 2026-08-21
...
revisión previa `REVIEW-2026-08-20-planificacion.md`.  
**Issues GitHub:** `gh issue list --state open` → **vacío** (sin bugs abiertos
visibles en el repo). **PRs abiertos:** #548 (tip honesty Timeline Limpiar
filtros; persistencia entre sesiones).
...
Desde la revisión 2026-08-20 el ciclo `0.4.3.dev0` sumó tips honesty
Timeline mergeados: Seguir (#539), periodo (#541), algoritmo (#542), evento
(#543), piece-moves (#544), markers (#545), replay-mode (#546), replay-speed
(#547). Snapshot planificación 08-20 mergeado (#540). PR abierto #548
(Timeline Limpiar filtros persiste). Sin Issues abiertos al corte de este pase.
