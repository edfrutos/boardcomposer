# Revisión de planificación — 2026-08-07
...
revisión previa `REVIEW-2026-08-06-planificacion.md`.  
...
Desde la revisión 2026-08-06 el ciclo `0.4.3.dev0` avanzó en barra de estado y
tips (PRs ~420–425): basename del `.bcproj`, clic abre carpeta, tip con ruta
cuando no hay guardado, tips de zoom (+/− y %) con atajos/rueda, guía rápida
alineada.
...
4. **QoL / producto `0.4.3`** — atacar cola IDE-0019…0024 (DOC-004) cuando
   haya capacidad; el pulido de status bar / tips no vacía esa cola.
