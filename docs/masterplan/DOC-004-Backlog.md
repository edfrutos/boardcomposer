...
| IDE-0049 | S | IDE-0042; SCR-006 | JSON de prefs; fusionar o reemplazar; sin nube |
...
**Estado actual:** 🟢 Actualizado — IDE-0001…0048 Studio/Core
completadas (ciclo `0.4.4` ola 1 + 0031…0048; `#647`/`#649`/`#651`/
`#653`/`#654`/`#655`/`#657`/`#658`/`#659`/`#661`/`#662`). IDE-0007 🟢
MVP+eval (2026-09-12; LLM diferido). EP (001…003) Fase 3 entregadas.
Snapshot: `REVIEW-2026-09-22-planificacion.md`.

Próximo foco:

1. Cola producto `0.4.4` quinta ola: IDE-0049…0050 (0048 entregada).
