...
IDE-0019…0024 siguen como ideas abiertas (revisión 2026-09-07: sin IDE
nuevas; cola no vacía; Issues abiertos = 0; PRs abiertos = 0; tip #601 +
planning #600 en `main`).
Ver `REVIEW-2026-09-07-planificacion.md`.
