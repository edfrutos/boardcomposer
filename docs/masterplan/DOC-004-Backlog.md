...
| IDE-0039 | S–M | SCR-007; export plan | En curso `#651`; pie SVG/PDF/DXF |
...
completadas en `main` (ciclo `0.4.4` ola 1 + 0031…0038; `#647`/`#649`).
IDE-0039 🟡 en `#651`. IDE-0007 🟢 MVP+eval (2026-09-12; LLM diferido).
EP (001…003) Fase 3 entregadas. Snapshot:
`REVIEW-2026-09-20-planificacion.md`.

Próximo foco:

1. Cerrar `#651` (IDE-0039); luego cola `0.4.4` residual IDE-0040…0042.
