# Revisión de planificación — 2026-09-03
...
revisión previa `REVIEW-2026-09-02-planificacion.md` (PR #595 draft, no
...
visibles en el repo). **PRs abiertos al corte:** 3
(`#593` tip honesty import-boards → proyecto vacío; `#594` planning 09-01
draft; `#595` planning 09-02 draft — ambos supersedidos por este snapshot).
...
08-31 (#588). Entre 09-01 y 09-03 **no hubo merges nuevos** a `main`. Al corte
09-03: **Issues abiertos = 0**; **PRs abiertos = 3** (#593 tip Importar
tableros → proyecto vacío; #594/#595 planning drafts 09-01/09-02, plegados
aquí).
