# Revisión de planificación — 2026-09-02
...
revisión previa `REVIEW-2026-09-01-planificacion.md` (PR #594 draft, no
mergeado; se incorpora aquí como histórico).  
...
draft — supersedido por este snapshot).
...
08-31 (#588). Entre 09-01 y 09-02 **no hubo merges nuevos** a `main`. Al corte
09-02: **Issues abiertos = 0**; **PRs abiertos = 2** (#593 tip Importar
tableros → proyecto vacío; #594 planning 09-01 draft, plegado aquí).
