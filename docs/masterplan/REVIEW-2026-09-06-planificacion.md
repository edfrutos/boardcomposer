# Revisión de planificación — 2026-09-06
...
revisión previa `REVIEW-2026-09-05-planificacion.md` (PR #598 mergeado).  
...
| Tips honesty Añadir tablero (crea proyecto vacío si no hay) | 🟢 QoL `0.4.3.dev0` |
...
Desde la revisión 2026-09-05, en `main` entraron planning #598 y tip honesty
Añadir tablero → proyecto vacío (#599). Al corte 09-06: **Issues abiertos =
0**; **PRs abiertos = 0**.
