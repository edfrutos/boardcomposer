...
- Cola ciclo `0.4.4` implementable vacía (quinta ola 0047…0050 cerrada).
...
cerrada; segunda ola IDE-0031…0036 entregada; 0037…0050 entregadas
(`#647`/`#649`/`#651`/`#653`/`#654`/`#655`/`#657`/`#658`/`#659`/`#661`/
`#662`/`#663`/`#664`); quinta ola cerrada. Revisión:
