...
- Cola ciclo `0.4.4` tercera ola: IDE-0042 (0037…0041 entregadas).
...
y 0039 trazabilidad de plano entregados (`#647`/`#649`/`#651`); 0040
unidades Inspector y 0041 capas DXF entregados; restante 0042. Revisión:
