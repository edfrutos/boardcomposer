...
- Cola ciclo `0.4.4` séptima ola: IDE-0057 🟡 `#676` (0056 `#675`; queda
  0058).
...
cerrada; segunda ola IDE-0031…0036 entregada; 0037…0056 entregadas
(`#647`/`#649`/`#651`/`#653`/`#654`/`#655`/`#657`/`#658`/`#659`/`#661`/
`#662`/`#663`/`#664`/`#665`/`#666`/`#667`/`#671`/`#672`/`#673`/`#675`);
sexta ola 0051…0054 cerrada; séptima ola 0055…0058 (0057 `#676` 🟡).
