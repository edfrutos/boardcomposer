...
- Cola ciclo `0.4.4` segunda ola restante: IDE-0036 (`#645`) →
  IDE-0035 (0031…0034 entregadas).
...
cerrada; segunda ola 0031…0034 cerrada; restante IDE-0036 (`#645`) +
IDE-0035. Revisión: `REVIEW-2026-09-17-planificacion.md`.
