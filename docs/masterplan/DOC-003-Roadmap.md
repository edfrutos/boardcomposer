...
- Cola ciclo `0.4.4` tercera ola: IDE-0042 `#655` 🟡 (0037…0041
  entregadas).
...
cerrada; segunda ola IDE-0031…0036 entregada; 0037…0041 entregadas
(`#647`/`#649`/`#651`/`#653`/`#654`); IDE-0042 en desarrollo (`#655`).
