...
- Candidatos producto IDE-0019…0024 (ver revisión 2026-08-15) cuando haya
  capacidad tras eval.
...
outdated/import·export + candidatos IDE-0019…0024). Revisión:
`REVIEW-2026-08-15-planificacion.md`.
