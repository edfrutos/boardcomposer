...
- Candidatos producto IDE-0019…0024 (ver revisión 2026-08-21) cuando haya
  capacidad tras eval.
...
outdated/import·export/Timeline + candidatos IDE-0019…0024). Revisión:
`REVIEW-2026-08-21-planificacion.md`.
