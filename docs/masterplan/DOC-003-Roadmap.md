...
- Cola ciclo `0.4.4`: IDE-0025 → 0028 → 0029
  (retales inventario, catálogo, coste; 0026/0027/0030 entregadas).
...
corte `0.4.3` cerrado; ciclo `0.4.4.dev0` con cola restante
IDE-0025 → 0028 → 0029 (0026/0027/0030 entregadas).
