...
- Cola ciclo `0.4.4` segunda ola: IDE-0034 → 0035 → 0036
  (0031, 0032 y 0033 entregadas).
...
corte `0.4.3` cerrado; ciclo `0.4.4.dev0` ola 1 (0025…0030) cerrada;
segunda ola restante IDE-0034…0036 (0031, 0032 y 0033 entregadas).
Revisión: `REVIEW-2026-09-16-planificacion.md`.
