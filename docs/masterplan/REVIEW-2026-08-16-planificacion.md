# Revisión de planificación — 2026-08-16
...
revisión previa `REVIEW-2026-08-15-planificacion.md`.  
...
Desde la revisión 2026-08-15 el ciclo `0.4.3.dev0` amplió la ola honesty
(PRs #511…#517 mergeados): preferences apply, save-as (archivo actual),
export selected/timeline (oferta abrir), save / save-as (anillo revisión),
fit-board (ignora selección). Snapshot planificación 08-15 mergeado (#510).
Sin PRs abiertos al corte de este pase.
