...
Revisión: `docs/masterplan/REVIEW-2026-09-03-planificacion.md`.
...
2. Ciclo `0.4.3.dev0` abierto — ola tips honesty Archivo/Edición/Ayuda/
   ...
   proyecto/export selección/Timeline + Importar piezas (PRs ~457–592;
   Issues = 0; PRs abiertos #593 tip import-boards + #594/#595 planning
   drafts plegados al corte 09-03); candidatos IDE-0019…0024 aún sin
   implementar (bajo demanda).
