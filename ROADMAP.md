...
1. Release **`0.4.3`** cortado (`v0.4.3`, 2026-09-14).
2. Ciclo `0.4.4.dev0` abierto — slices QoL bajo demanda (backlog grande
   bloqueado).
3. Cola producto IDE-0019…0024 cerrada en `0.4.3` (metadatos, swap, kerf,
