...
Revisión: `docs/masterplan/REVIEW-2026-08-25-planificacion.md`.
...
2. Ciclo `0.4.3.dev0` abierto — ola tips honesty Archivo/Edición/Ayuda/
   ...
   comparador + Calcular layout + Abrir carpeta/barra estado (PRs ~457–565;
   cola tips sin PRs abiertos); candidatos IDE-0019…0024 aún sin implementar
   (bajo demanda).
