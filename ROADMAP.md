...
Revisión: `docs/masterplan/REVIEW-2026-08-22-planificacion.md`.

1. Release **`0.4.2`** cortado (`v0.4.2`, 2026-08-02) — hecho.
2. Ciclo `0.4.3.dev0` abierto — ola tips honesty Archivo/Edición/Ayuda/
   plantillas/outdated/confirmaciones/import·export + Timeline/Vista
   persiste (PRs ~457–552; cola tips sin PRs abiertos); candidatos
