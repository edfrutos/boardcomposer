...
Revisión: `docs/masterplan/REVIEW-2026-09-17-planificacion.md`.

1. Release **`0.4.3`** / `v0.4.3` publicado (2026-09-16).
2. Ciclo **`0.4.4.dev0`** — cola segunda ola IDE-0031…0036
   entregada (0036 hueco asistido `#645`; 0035 lote `#644`; 0034 papel
   PDF; 0031 medidas, 0033 etiquetas retal y 0032 presupuesto PDF;
