...
Revisión: `docs/masterplan/REVIEW-2026-08-21-planificacion.md`.

1. Release **`0.4.2`** cortado (`v0.4.2`, 2026-08-02) — hecho.
2. Ciclo `0.4.3.dev0` abierto — ola tips honesty Archivo/Edición/Ayuda/
   plantillas/outdated/confirmaciones/import·export + Timeline persiste
   (PRs ~457–547; #548 abierto); candidatos IDE-0019…0024 aún sin
