...
Revisión: `docs/masterplan/REVIEW-2026-09-26-planificacion.md`.

1. Release **`0.4.3`** / `v0.4.3` publicado (2026-09-16).
2. Ciclo **`0.4.4.dev0`** — séptima ola cerrada (0058 entregada; 0057 entregada; 0056 entregada; 0055 `#673`;
   ...
   0031…0036; ola 1 0025…0030). Cola implementable vacía.
