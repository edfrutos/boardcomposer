"""Command for adding pieces (and placements) to the project (FLW-006)."""
...
class AddPieceCommand(Command):
    """Append one or more pieces with placements; undo removes them by id."""

    name: str = "Añadir pieza"
