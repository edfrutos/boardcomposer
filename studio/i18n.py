...
_STRINGS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "prefs.export_panel_dimensions": "Cotas L×A del tablero",
        "prefs.export_plan_traceability": ("Trazabilidad (versión, algoritmo, fecha)"),
        ...
        "tip.restore_local_revision": (
            ...
            "(Ctrl+Alt+Y); pide confirmación; los cambios sin guardar se pierden · "
            "Guardar para escribir en disco"
        ),
        ...
        "tip.zoom_100": "Volver el zoom del Workspace al 100% (Ctrl+Alt+0)",
        "status.zoom_already_100": "El zoom ya está al 100%",
        ...
        "inspector.total_length": "Largo total: {value}",
        "inspector.total_width": "Ancho total: {value}",
        "inspector.internal_waste": "Huecos internos: {value}",
        "inspector.free_material": "Material libre: {value}",
        "inspector.material_cost": "Coste material: {value}",
        "inspector.omitted": "Piezas omitidas: {ids}",
        "inspector.offcuts": ("Retales aprovechables: {n} (área total {area})"),
        ...
        "inspector.boards_summary": ("Tableros: {types} tipos · {physical} físicos"),
        "inspector.pieces_summary": (
            "Piezas: {total} ({placed} colocadas, {unplaced} sin colocar)"
        ),
        "inspector.solutions_summary": "Soluciones: {n}",
        "inspector.materials": "Materiales: {items}",
        "inspector.stock_area": "Área de stock: {area}",
        "inspector.pieces_area": "Área de piezas: {area}",
        "inspector.category_boards": "Tableros",
        "inspector.category_pieces": "Piezas",
        "inspector.category_solutions": "Soluciones",
        "inspector.board_types": "Tipos: {n}",
        "inspector.board_physical": "Físicos: {n}",
        "inspector.board_remnants": "Retales de inventario: {n}",
        "inspector.pieces_total": "Total: {n}",
        "inspector.pieces_placed": "Colocadas: {n}",
        "inspector.pieces_unplaced": "Sin colocar: {n}",
        "inspector.solutions_candidates": "Candidatas: {n}",
        "inspector.solutions_selected": "Seleccionada: {current} / {total}",
        "inspector.solutions_none": "Sin candidatas calculadas",
        "inspector.board_instances_used": ("Instancias usadas: {used} / {quantity}"),
        "inspector.board_utilization": "Aprovechamiento: {value}",
        "inspector.board_no_layout": "Sin layout en este tablero",
        "inspector.board_unused": "Sin piezas en este tablero",
        "comparator.pieces": "Piezas",
        "comparator.waste": "Huecos",
        "comparator.board_free": "Tablero libre",
        "comparator.cost": "Coste",
        ...
        "highlight.cost": "Menor coste de material",
        ...
        "export.offcut_labels": "Etiquetas de retales (medidas)",
        "export.panel_dimensions": "Cotas L×A del tablero",
        "export.plan_traceability": "Trazabilidad (versión, algoritmo, fecha)",
        "export.pdf_paper": "Papel (PDF):",
        "export.pdf_orientation": "Orientación (PDF):",
        "export.pdf_scale": "Escala (PDF):",
        "export.pdf_margin": "Márgenes (PDF):",
        "export.raster_dpi": "Resolución (DPI):",
        "export.jpeg_quality": "Calidad JPEG:",
        "export.paper_drawing": "Ajustar al dibujo",
        "export.paper_a4": "A4",
        "export.paper_a3": "A3",
        "export.paper_letter": "Letter",
        "export.orientation_auto": "Automática",
        "export.orientation_portrait": "Vertical",
        "export.orientation_landscape": "Apaisado",
        "export.scale_fit": "Ajustar a la página",
        "export.scale_1_1": "1:1",
        ...
        "diff.metric.length": "Largo total",
        "diff.metric.width": "Ancho total",
        "diff.metric.panels": "Paneles usados",
        "diff.metric.offcuts": "Retales",
        "diff.metric.score": "Puntuación",
        "diff.metric.cost": "Coste material (€)",
    ...
    "en": {
        ...
        "prefs.export_panel_dimensions": "Panel L×W dimensions",
        "prefs.export_plan_traceability": ("Traceability (version, algorithm, date)"),
        ...
        "tip.restore_local_revision": (
            ...
            "prompts for confirmation; unsaved changes are discarded · "
        ...
        "tip.zoom_100": "Reset Workspace zoom to 100% (Ctrl+Alt+0)",
        "status.zoom_already_100": "Zoom is already at 100%",
        ...
        "inspector.total_length": "Total length: {value}",
        "inspector.total_width": "Total width: {value}",
        "inspector.internal_waste": "Internal gaps: {value}",
        "inspector.free_material": "Free material: {value}",
        "inspector.material_cost": "Material cost: {value}",
        "inspector.omitted": "Omitted pieces: {ids}",
        "inspector.offcuts": ("Usable offcuts: {n} (total area {area})"),
        ...
        "inspector.boards_summary": ("Boards: {types} types · {physical} physical"),
        "inspector.pieces_summary": (
            "Pieces: {total} ({placed} placed, {unplaced} unplaced)"
        ),
        "inspector.solutions_summary": "Solutions: {n}",
        "inspector.materials": "Materials: {items}",
        "inspector.stock_area": "Stock area: {area}",
        "inspector.pieces_area": "Piece area: {area}",
        "inspector.category_boards": "Boards",
        "inspector.category_pieces": "Pieces",
        "inspector.category_solutions": "Solutions",
        "inspector.board_types": "Types: {n}",
        "inspector.board_physical": "Physical: {n}",
        "inspector.board_remnants": "Inventory offcuts: {n}",
        "inspector.pieces_total": "Total: {n}",
        "inspector.pieces_placed": "Placed: {n}",
        "inspector.pieces_unplaced": "Unplaced: {n}",
        "inspector.solutions_candidates": "Candidates: {n}",
        "inspector.solutions_selected": "Selected: {current} / {total}",
        "inspector.solutions_none": "No calculated candidates",
        "inspector.board_instances_used": "Instances used: {used} / {quantity}",
        "inspector.board_utilization": "Utilization: {value}",
        "inspector.board_no_layout": "No layout on this board",
        "inspector.board_unused": "No pieces on this board",
        ...
        "highlight.cost": "Lower material cost",
        ...
        "export.offcut_labels": "Offcut labels (size)",
        "export.panel_dimensions": "Panel L×W dimensions",
        "export.plan_traceability": "Traceability (version, algorithm, date)",
        "export.pdf_paper": "Paper (PDF):",
        "export.pdf_orientation": "Orientation (PDF):",
        "export.pdf_scale": "Scale (PDF):",
        "export.pdf_margin": "Margins (PDF):",
        "export.raster_dpi": "Resolution (DPI):",
        "export.jpeg_quality": "JPEG quality:",
        "export.paper_drawing": "Fit drawing",
        "export.paper_a4": "A4",
        "export.paper_a3": "A3",
        "export.paper_letter": "Letter",
        "export.orientation_auto": "Automatic",
        "export.orientation_portrait": "Portrait",
        "export.orientation_landscape": "Landscape",
        "export.scale_fit": "Fit page",
        "export.scale_1_1": "1:1",
        "export.scale_1_2": "1:2",
        "export.scale_1_5": "1:5",
        "export.scale_1_10": "1:10",
        ...
        "diff.metric.length": "Total length",
        "diff.metric.width": "Total width",
        "diff.metric.panels": "Panels used",
        "diff.metric.offcuts": "Offcuts",
        "diff.metric.score": "Score",
        "diff.metric.cost": "Material cost (€)",
