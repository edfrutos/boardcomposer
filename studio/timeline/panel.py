...
class TimelinePanel(QWidget):
    ...
    def _sync_event_actions(self) -> None:
        ...
        piece_moves_tip = tr("tip.timeline_filter_piece_moves", self._language)
        self._piece_moves.setToolTip(piece_moves_tip)
        self._piece_moves.setStatusTip(piece_moves_tip)
        self._markers.setChecked(self._filter_event == TIMELINE_MARKED)
        markers_tip = tr("tip.timeline_filter_markers", self._language)
        self._markers.setToolTip(markers_tip)
        self._markers.setStatusTip(markers_tip)
        self._follow.setChecked(self._follow_latest)
        follow_tip = tr("tip.timeline_follow", self._language)
