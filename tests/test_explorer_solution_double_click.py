"""Double-clicking a solution in the Explorador previews it."""
...
def test_explorer_double_click_solution_selects_preview(qapp, tmp_path, monkeypatch):
    del qapp
    ...
    services.layout.solutions = [
        ...
        AssemblySolution(placements=[BoardPlacement("A", 10, 10, 100, 50)]),
    ]
    ...
    window._on_explorer_item_double_clicked(item, 0)
